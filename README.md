[![npm version](https://img.shields.io/npm/v/@cycube/guacamole-common-js.svg)](https://www.npmjs.com/package/@cycube/guacamole-common-js) [![downloads](https://img.shields.io/npm/dt/@cycube/guacamole-common-js.svg)](https://www.npmjs.com/package/@cycube/guacamole-common-js)
...
This is a fork of [padarom/guacamole-common-js.git](https://github.com/padarom/guacamole-common-js.git) (which is itself a fork of [glyptodon/guacamole-client](https://github.com/glyptodon/guacamole-client))
...
```
npm install --save @cycube/guacamole-common-js
```

```js
const Guacamole = require('@cycube/guacamole-common-js');

// ... or ES6
import Guacamole from '@cycube/guacamole-common-js';
```
